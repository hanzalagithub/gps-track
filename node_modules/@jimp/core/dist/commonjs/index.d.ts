...
type JimpFormat<M extends string = string, O extends Record<string, any> | undefined = undefined, T extends Format<M, O> = Format<M, O>> = () => T;
...
export declare function createJimp<Methods extends JimpPlugin[], Formats extends JimpFormat[]>({ plugins: pluginsArg, formats: formatsArg, }?: {
     ...
     * ```
     */
    fromBuffer(buffer: Buffer | ArrayBuffer): Promise<{
        /**
         * The bitmap data of the image
         */
        bitmap: Bitmap;
    ...
    clone<S extends {
         ...
         * ```
         */
        read(url: string): Promise<any & JimpInstanceMethods<any, UnionToIntersection<Methods[number]>>>;
        /**
         * Create a Jimp instance from a bitmap.
         * The difference between this and just using the constructor is that this will
         * convert raw image data into the bitmap format that Jimp uses.
         ...
         * ```
         */
        fromBuffer(buffer: Buffer | ArrayBuffer): Promise<any & JimpInstanceMethods<any, UnionToIntersection<Methods[number]>>>;
    }>(this: S): S;
    /**
     * Returns the offset of a pixel in the bitmap buffer
     * @param x the x coordinate
